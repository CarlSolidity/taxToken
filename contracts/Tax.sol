...
contract Tax is ERC20, Ownable {
    ...
    address public taxCollector = 0x0000000000000000000000000000000000000000;
    ...
    uint256 public _totalTaxedTokens;
    ...
    constructor(
        ...
        console.log("Owner amount is %s:", balanceOf(msg.sender));
    ...
    function _transfer(
        ...
        uint tokensToTax = calculateTokenTax(
            amount,
            feeDecimals,
            feePercentage
        );
        ...
        super._transfer(from, taxCollector, tokensToTax);
        super._transfer(from, to, tokensToTransfer);

        console.log("balance of %s is: %s", from, balanceOf(from));
        console.log("balance of %s is: %s", taxCollector, balanceOf(taxCollector));
        console.log("balance of %s is: %s", to, balanceOf(to));
    }

    function calculateTokenTax(
        uint256 _amount,
        uint8 _feeDecimals,
        uint32 _feePercentage
    ...
    function updateTaxCollector(address _newTaxCollector) public onlyOwner {
